...
module.exports = class Rule {
  ...
  /**
   *
   * @returns {{type: (string), required: boolean, min: (undefined|*), max: (undefined|*), type_of: (undefined|*), one_of: (undefined|*|Array), len: (undefined|*), null: boolean, match: (undefined|*|RegExp)}}
   */
  getSpecs() {
    return this.specs;
  }
